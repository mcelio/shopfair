...
import com.shopfare.dataaccessobject.StoreRepository;
import com.shopfare.service.car.StoreService;
...
public class StoreControllerTest {
  ...
  private static final String LOGIN_JSON = "{\"username\": \"shopfare\",\"password\" : \"shopfare\"}";
  ...
  @Test
  @WithMockUser(username = "shopfare", password = "shopfare", roles = "USER")
